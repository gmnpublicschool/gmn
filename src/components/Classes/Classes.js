...
import classImg1 from './../../assets/img/class-1.jpg';
import classImg2 from './../../assets/img/class-2.jpg';
import classImg3 from './../../assets/img/class-3.jpg';
function Classes() {
    return ( 
        <>
            {/* Banner Start */}
            <Banner heading={'Our Classes'} SubHeading={'Our Classes In GMN School'} />
            {/* Banner End */}
                    ...
                    <div className="row">
                        <div className="col-lg-4 mb-5">
                            <div className="card border-0 bg-light shadow-sm pb-2">
                                <img className="card-img-top mb-2" src={classImg1} alt="" />
                        ...
                        <div className="col-lg-4 mb-5">
                            <div className="card border-0 bg-light shadow-sm pb-2">
                                <img className="card-img-top mb-2" src={classImg2} alt="" />
                                <div className="card-body text-center">
                        ...
                        <div className="col-lg-4 mb-5">
                            <div className="card border-0 bg-light shadow-sm pb-2">
                                <img className="card-img-top mb-2" src={classImg3} alt="" />
                                <div className="card-body text-center">
